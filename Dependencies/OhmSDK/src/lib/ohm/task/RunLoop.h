...
#if ! defined (ohm_task_RunLoop_HEADER_INCLUDED)
#define  ohm_task_RunLoop_HEADER_INCLUDED
...
private:
   ...
   bool           operator == (const RunLoop &other);
   bool           operator != (const RunLoop &other);
...
//#include "ohm/task/RunLoop.hpp"



#endif   // ohm_task_RunLoop_HEADER_INCLUDED
