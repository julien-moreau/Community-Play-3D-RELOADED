...
#if ! defined (ohm_opak_MarkStack_HEADER_INCLUDED)
#define  ohm_opak_MarkStack_HEADER_INCLUDED
...
#include "ohm/opak/private/MarkStack.hpp"



#endif   // ohm_opak_MarkStack_HEADER_INCLUDED
