...
#include "ohm/opak/ImageStretched.h"
...
ImageStretched::ImageStretched ()
:  _image (*this, &ImageStretched::image_changed)
...
void  ImageStretched::display (GraphicContext & context)
{
...
void  ImageStretched::image_changed ()
{
   invalidate_all ();
