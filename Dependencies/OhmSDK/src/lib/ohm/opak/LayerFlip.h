...
#if ! defined (ohm_opak_LayerFlip_HEADER_INCLUDED)
#define  ohm_opak_LayerFlip_HEADER_INCLUDED
...
private:
                  LayerFlip (const LayerFlip &other);
   LayerFlip &    operator = (const LayerFlip &other);
   bool           operator == (const LayerFlip &other);
   bool           operator != (const LayerFlip &other);
...
//#include  "ohm/opak/LayerFlip.hpp"



#endif   // ohm_opak_LayerFlip_HEADER_INCLUDED
