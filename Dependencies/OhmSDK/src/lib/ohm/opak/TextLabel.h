...
#if ! defined (ohm_opak_TextLabel_HEADER_INCLUDED)
#define  ohm_opak_TextLabel_HEADER_INCLUDED
...
private:
   ...
   TextLabel & operator = (const TextLabel &other);
   bool           operator == (const TextLabel &other);
   bool           operator != (const TextLabel &other);
...
//#include  "ohm/opak/TextLabel.hpp"



#endif   // ohm_opak_TextLabel_HEADER_INCLUDED
