...
#if defined (ohm_sys_ThreadSyncImpl_CURRENT_HEADER)
   #error Recursive inclusion of ohm/sys/ThreadSyncImpl header.
#endif
#define  ohm_sys_ThreadSyncImpl_CURRENT_HEADER
...
#undef ohm_sys_ThreadSyncImpl_CURRENT_HEADER
