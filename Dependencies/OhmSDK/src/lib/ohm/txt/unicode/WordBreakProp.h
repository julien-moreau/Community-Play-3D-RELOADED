...
#if ! defined (ohm_txt_unicode_WordBreakProp_HEADER_INCLUDED)
#define  ohm_txt_unicode_WordBreakProp_HEADER_INCLUDED
...
//#include  "ohm/txt/unicode/WordBreakProp.hpp"



#endif   // ohm_txt_unicode_WordBreakProp_HEADER_INCLUDED
