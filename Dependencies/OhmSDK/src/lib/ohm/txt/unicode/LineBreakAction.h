...
#if ! defined (ohm_txt_unicode_LineBreakAction_HEADER_INCLUDED)
#define  ohm_txt_unicode_LineBreakAction_HEADER_INCLUDED
...
//#include  "ohm/txt/unicode/LineBreakAction.hpp"



#endif   // ohm_txt_unicode_LineBreakAction_HEADER_INCLUDED
