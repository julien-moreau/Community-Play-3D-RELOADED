...
#if ! defined (ohm_flip_ConvFloat64_HEADER_INCLUDED)
#define  ohm_flip_ConvFloat64_HEADER_INCLUDED
...
private:
                  ConvFloat64 (const ConvFloat64 &other);
   ConvFloat64 &  operator = (const ConvFloat64 & other);
   bool           operator == (const ConvFloat64 &other);
   bool           operator != (const ConvFloat64 &other);
...
#endif   // ohm_flip_ConvFloat64_HEADER_INCLUDED
