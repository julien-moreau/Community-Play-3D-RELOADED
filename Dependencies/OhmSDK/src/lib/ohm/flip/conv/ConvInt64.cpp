...
void  ConvInt64::collect (std::list <ConvObject *> & obj_ptr_arr)
{
   // "BasicTypes are not writable"
...
void  ConvInt64::write_xml (ContextXml & ctx) const
{
...
const char * ConvInt64::get_class_name ()
{
   return BasicTypesName::_int64_0;
}
...
void  ConvInt64::do_write_member (DataStreamOutput & dst) const
{
   DocumentFormatter::write_member_int64 (dst, _val);
}
...
void  ConvInt64::do_write_member_container (DataStreamOutput & dst) const
{
   DocumentFormatter::write_member_container_int64 (dst, _val);
}
