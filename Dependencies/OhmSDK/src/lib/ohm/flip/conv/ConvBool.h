...
#if ! defined (ohm_flip_ConvBool_HEADER_INCLUDED)
#define  ohm_flip_ConvBool_HEADER_INCLUDED
...
private:
                  ConvBool (const ConvBool &other);
   ConvBool &     operator = (const ConvBool & other);
   bool           operator == (const ConvBool &other);
   bool           operator != (const ConvBool &other);
...
#endif   // ohm_flip_ConvBool_HEADER_INCLUDED
