...
#if ! defined (ohm_flip_ConvCue_HEADER_INCLUDED)
#define  ohm_flip_ConvCue_HEADER_INCLUDED
...
private:
                  ConvCue (const ConvCue &other);
   ConvCue &      operator = (const ConvCue & other);
   bool           operator == (const ConvCue &other);
   bool           operator != (const ConvCue &other);
...
#endif   // ohm_flip_ConvCue_HEADER_INCLUDED
