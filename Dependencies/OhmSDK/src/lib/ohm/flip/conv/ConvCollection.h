...
#if ! defined (ohm_flip_ConvCollection_HEADER_INCLUDED)
#define  ohm_flip_ConvCollection_HEADER_INCLUDED
...
private:
                  ConvCollection (const ConvCollection &other);
   ConvCollection &     operator = (const ConvCollection & other);
   bool           operator == (const ConvCollection &other);
   bool           operator != (const ConvCollection &other);
...
#endif   // ohm_flip_ConvCollection_HEADER_INCLUDED
