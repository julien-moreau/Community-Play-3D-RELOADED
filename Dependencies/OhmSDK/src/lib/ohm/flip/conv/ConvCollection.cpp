...
bool  ConvCollection::has_ref_collision (std::set <flip::Ref> & ref_set) const
{
...
void  ConvCollection::propagate_remap (UserIdThreadIdRefMap & user_id_thread_id_ref_map, RefConvMap & ref_conv_map)
{
...
void  ConvCollection::rebind (RefConvMap & ref_conv_map)
{
   // propagate
...
void ConvCollection::propagate_collect_max_id (UserIdRefMap & user_id_ref_map)
{
   // propagate
...
void  ConvCollection::collect (std::list <ConvObject *> & obj_ptr_arr)
{
   // "BasicTypes are not writable"
...
void  ConvCollection::propagate_trace ()
{
   // propagate
...
void  ConvCollection::write_xml (ContextXml & ctx) const
{
...
const char * ConvCollection::get_class_name ()
{
   return BasicTypesName::_collection_0;
}
...
void  ConvCollection::do_write_member (DataStreamOutput & dst) const
{
   ...
   for (; it != it_end ; ++it)
   {
      ...
      DocumentFormatter::write_member_collection_ref (
         dst,
...
void  ConvCollection::do_write_member_container (DataStreamOutput & dst) const
{
   // not supported
