...
#if ! defined (ohm_flip_ConvObjectRef_HEADER_INCLUDED)
#define  ohm_flip_ConvObjectRef_HEADER_INCLUDED
...
private:
                  ConvObjectRef (const ConvObjectRef &other);
   ConvObjectRef &      operator = (const ConvObjectRef & other);
   bool           operator == (const ConvObjectRef &other);
   bool           operator != (const ConvObjectRef &other);
...
#endif   // ohm_flip_ConvObjectRef_HEADER_INCLUDED
