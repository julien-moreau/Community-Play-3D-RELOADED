...
#if ! defined (ohm_flip_ConvInt64_HEADER_INCLUDED)
#define  ohm_flip_ConvInt64_HEADER_INCLUDED
...
private:
                  ConvInt64 (const ConvInt64 &other);
   ConvInt64 &    operator = (const ConvInt64 & other);
   bool           operator == (const ConvInt64 &other);
   bool           operator != (const ConvInt64 &other);
...
#endif   // ohm_flip_ConvInt64_HEADER_INCLUDED
