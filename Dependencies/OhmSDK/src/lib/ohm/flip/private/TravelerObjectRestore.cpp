...
TravelerObjectRestore::TravelerObjectRestore (DocumentBase & document)
...
TravelerObjectRestore::~TravelerObjectRestore ()
{
}
...
void  TravelerObjectRestore::operator () (flip::Ref ref)
{
