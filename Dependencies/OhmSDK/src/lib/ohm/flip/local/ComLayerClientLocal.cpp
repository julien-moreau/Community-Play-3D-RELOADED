...
ComLayerClientLocal::ComLayerClientLocal (const char * user_name_0, ClientLocal & client_local)
:  flip::ComLayerClientBase ()
,  _client_local (client_local)
...
void  ComLayerClientLocal::local_receive (const flip::DataMaster & data)
{
   receive (data);
}
...
void  ComLayerClientLocal::do_send (const flip::DataMaster & data)
{
