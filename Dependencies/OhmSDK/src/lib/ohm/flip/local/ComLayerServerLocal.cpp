...
void  ComLayerServerLocal::bind (task::RunLoopBase & run_loop)
{
   assert (&run_loop != 0);
...
void  ComLayerServerLocal::local_receive (const std::string & from, const DataMaster & data)
{
   assert (_run_loop_ptr != 0);
...
void  ComLayerServerLocal::do_send (const std::string & to, const archi::UByte * data_ptr, size_t data_size)
{
   ...
   DataSPtr data_sptr (new Data (data_ptr, data_ptr + data_size));
...
void  ComLayerServerLocal::do_broadcast (const archi::UByte * data_ptr, size_t data_size)
{
   FromComLayerClientLocalPtrMap::iterator it
...
void  ComLayerServerLocal::do_broadcast (const std::string & except, const archi::UByte * data_ptr, size_t data_size)
{
   FromComLayerClientLocalPtrMap::iterator it
      = _from_com_layer_client_local_ptr_map.begin ();
   FromComLayerClientLocalPtrMap::iterator it_end
...
void  ComLayerServerLocal::process (task::Event & event)
{
