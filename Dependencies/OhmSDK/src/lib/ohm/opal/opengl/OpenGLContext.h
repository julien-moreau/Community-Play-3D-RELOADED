...
#if ! defined (ohm_opal_OpenGLContext_HEADER_INCLUDED)
#define  ohm_opal_OpenGLContext_HEADER_INCLUDED
...
public:
                  ...
                  OpenGLContext (OpenGLEngine & engine);
...
private:
   ...
   bool           operator == (const OpenGLContext &other);
   bool           operator != (const OpenGLContext &other);
...
#endif   // ohm_opal_OpenGLContext_HEADER_INCLUDED
