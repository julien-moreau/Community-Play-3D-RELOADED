...
#if ! defined (ohm_opa_WidgetPushButtonSmall_HEADER_INCLUDED)
#define  ohm_opa_WidgetPushButtonSmall_HEADER_INCLUDED
...
class WidgetPushButtonSmall;
typedef mem::SharedPtr <WidgetPushButtonSmall>  WidgetPushButtonSmallSPtr;

class WidgetPushButtonSmall
:  public WidgetBase
,  public WidgetCreationHelper <WidgetPushButtonSmall>
{
...
public:
   ...
   {
   public:
                  Event (WidgetPushButtonSmall & widget, opal::Event & event) : _widget (widget), _event (event) {}
   ...
   virtual        ~WidgetPushButtonSmall ();
   
   void           set_type_plus_sign ();
   void           set_type_minus_sign ();
   void           set_type_refresh_sign ();
   void           set_type_arrow_left_sign ();
   void           set_type_arrow_right_sign ();
...
private:
   ohm_opa_WidgetCreationHelper_INVITE (WidgetPushButtonSmall);
   ...
   opal::AutoFramePtr <opal::FrameKey>
                  _frame_key_aptr;
   opak::AutoPrimPtr <PrimPushButtonSmall>
                  _prim_aptr;
...
private:
                  WidgetPushButtonSmall (const WidgetPushButtonSmall &other);
   WidgetPushButtonSmall & operator = (const WidgetPushButtonSmall &other);
   bool           operator == (const WidgetPushButtonSmall &other);
   bool           operator != (const WidgetPushButtonSmall &other);
...
#include "ohm/opa/WidgetPushButtonSmall.hpp"



#endif   // ohm_opa_WidgetPushButtonSmall_HEADER_INCLUDED
