...
AspectWidgetMatrixBool::AspectWidgetMatrixBool ()
{
}
...
void  AspectWidgetMatrixBool::make (opak::GraphicContext & context)
{
   ...
   if (update_flag)
   {
      ...
      _label_color = aspect_widget.get_color_gray (.7f);
   }
}
...
void  AspectWidgetMatrixBool::do_init (opak::GraphicContext & context)
{
   load_base_elements ();
   ...
   /*_cell_over = im.get_sprung_image (
      "ohm.widget.matrix_bool.over.png", opa::Rect (0, 0, 1, 12)
   );*/
}
...
void  AspectWidgetMatrixBool::load_base_elements ()
{
   if (_be._base.size () == 0)
   {
...
AspectWidgetMatrixBool::BaseElements   AspectWidgetMatrixBool::_be;
