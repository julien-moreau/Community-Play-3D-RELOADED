...
AspectWidgetDialog::AspectWidgetDialog ()
{
}
...
void  AspectWidgetDialog::make (opak::GraphicContext & context)
{
   ...
   {
      {
         ...
         _header = opal::SprungImage (context.get (), bitmap, opa::Rect (44, 28, 1, 1));
      }
      
      {
         ...
         _content = opal::SprungImage (context.get (), bitmap, opa::Rect (44, 10, 1, 1));
      }
      
      {
         ...
         _footer = opal::SprungImage (context.get (), bitmap, opa::Rect (44, 0, 1, 1));
      }
   }
}
...
void  AspectWidgetDialog::do_init (opak::GraphicContext & context)
{
   load_base_elements ();
   ...
   /*_shadow = im.get_sprung_image (
      "ohm.widget.dialog.shadow.png", opa::Rect (60, 53, 150, 150)
   );*/
}
...
void  AspectWidgetDialog::load_base_elements ()
{
   if (_be._header.size () == 0)
   {
      ...
      ok_flag = il.load (_be._header, "ohm.widget.dialog.header.png");
      assert (ok_flag);
      
      ok_flag = il.load (_be._content, "ohm.widget.dialog.content.png");
      assert (ok_flag);
      
      ok_flag = il.load (_be._footer, "ohm.widget.dialog.footer.png");
      assert (ok_flag);
   }
}
...
AspectWidgetDialog::BaseElements AspectWidgetDialog::_be;
