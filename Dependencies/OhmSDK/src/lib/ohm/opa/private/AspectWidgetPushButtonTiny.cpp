/*****************************************************************************
        ...
        AspectWidgetPushButtonTiny.cpp
...
AspectWidgetPushButtonTiny::AspectWidgetPushButtonTiny ()
{
}
...
void  AspectWidgetPushButtonTiny::make (opak::GraphicContext & context)
{
...
void  AspectWidgetPushButtonTiny::do_init (opak::GraphicContext & context)
{
   load_base_elements ();
...
void  AspectWidgetPushButtonTiny::load_base_elements ()
{
   if (_be._back_arr [State_OFF].size () == 0)
   {
      ...
      ok_flag = il.load (_be._back_arr [State_OFF], "ohm.widget.pushbutton.tiny.off.png");
      assert (ok_flag);
      
      ok_flag = il.load (_be._back_arr [State_ON], "ohm.widget.pushbutton.tiny.on.png");
      assert (ok_flag);

      ok_flag = il.load (_be._back_arr [State_OVER], "ohm.widget.pushbutton.tiny.over.png");
      assert (ok_flag);

      ok_flag = il.load (_be._front_arr [Type_CANCEL_SIGN], "ohm.widget.pushbutton.tiny.cancel.png");
      assert (ok_flag);
   }
}
...
AspectWidgetPushButtonTiny::BaseElements  AspectWidgetPushButtonTiny::_be;
