...
#if ! defined (ohm_opa_WidgetPushButtonBase_HEADER_INCLUDED)
#define  ohm_opa_WidgetPushButtonBase_HEADER_INCLUDED
...
class WidgetPushButtonBase;
typedef mem::SharedPtr <WidgetPushButtonBase>   WidgetPushButtonBaseSPtr;

class WidgetPushButtonBase
:  public WidgetBase
,  public WidgetCreationHelper <WidgetPushButtonBase>
{
...
public:
   ...
   public:
      ...
      enum Type
      {
                  ...
                  Event (Type type, WidgetPushButtonBase & widget, opal::Event & event) : _type (type), _widget (widget), _event (event) {}
...
private:
   ohm_opa_WidgetCreationHelper_INVITE (WidgetPushButtonBase);
   ...
   opal::AutoFramePtr <opal::FrameKey>
                  _frame_key_aptr;
   opak::AutoPrimPtr <PrimPushButton>
                  _prim_aptr;
...
private:
                  WidgetPushButtonBase (const WidgetPushButtonBase &other);
   WidgetPushButtonBase &  operator = (const WidgetPushButtonBase &other);
   bool           operator == (const WidgetPushButtonBase &other);
   bool           operator != (const WidgetPushButtonBase &other);
...
#include "ohm/opa/base/WidgetPushButtonBase.hpp"



#endif   // ohm_opa_WidgetPushButtonBase_HEADER_INCLUDED
