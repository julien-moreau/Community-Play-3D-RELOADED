...
WidgetEmbedderBase::WidgetEmbedderBase ()
{
}
...
WidgetEmbedderBase::~WidgetEmbedderBase ()
{
   WidgetLayoutManager::use_instance ().remove (*this);
}
...
Name : update_layout
Description :
   Called from 'WidgetLayoutManager', actual notification for widget relayout
   operation.
==============================================================================
*/
...
void  WidgetEmbedderBase::invalidate_layout ()
{
