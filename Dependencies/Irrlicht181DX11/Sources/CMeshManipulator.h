...
public:
	...
	virtual s32 getPolyCount(IAnimatedMesh* mesh) const _IRR_OVERRIDE_;

	virtual IAnimatedMesh* createAnimatedMesh(IMesh* mesh, E_ANIMATED_MESH_TYPE type) const _IRR_OVERRIDE_;
